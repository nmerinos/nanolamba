...
#define USBD_PID                      0x5740 // 0x5710: Mouse
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "nanolambda"
#define USBD_PRODUCT_HS_STRING        "NSP32(TM)-HighSpeed"
#define USBD_PRODUCT_FS_STRING        "NSP32(TM)"
#define USBD_CONFIGURATION_HS_STRING  "Apollo Test Config"
#define USBD_INTERFACE_HS_STRING      "Apollo Test Interface"
#define USBD_CONFIGURATION_FS_STRING  "Apollo Test Config"
#define USBD_INTERFACE_FS_STRING      "Apollo Test Interface"
