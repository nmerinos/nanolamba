...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examples_sdk_device_spectrum: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examples_sdk_device_spectrum ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/examples_sdk_device_spectrum.o: examples_sdk_device_spectrum.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples_sdk_device_spectrum.o examples_sdk_device_spectrum.cpp
