...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examples_device_spectrum_api: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/examples_device_spectrum_api ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/examples_device_spectrum_api.o: examples_device_spectrum_api.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples_device_spectrum_api.o examples_device_spectrum_api.cpp

${OBJECTDIR}/examples_devices_spectrum_api.o: examples_devices_spectrum_api.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/examples_devices_spectrum_api.o examples_devices_spectrum_api.cpp
